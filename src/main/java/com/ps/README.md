...
The goal of this application is to manage, add, and view transactions. The user can add a deposit or a payment, and are also  able to view all transactions or filter them viewing only deposits or only payments to their liking.
...
When entering the password, a popup will appear which allows for security of the user's password.
